...
-- ==============================================================================
-- 15. MÓDULO: VEHÍCULOS BUSCADOS (WANTED VEHICLES & BUYER MATCHING ENGINE)
-- ==============================================================================
...
-- ==============================================================================
-- 16. MÓDULO: SORTEOS Y PREMIOS (GIVEAWAYS & PRIZES)
-- ==============================================================================

-- Tabla de Sorteos (Giveaways)
...
-- Tabla de Premios por Sorteo (1°, 2°, 3° premio, etc.)
...
-- Tabla de Participantes Inscriptos
...
-- Foreign Key cruzada para winner_participant_id
DO $$
BEGIN
    IF NOT EXISTS (
...
-- Bucket de Storage para Imágenes de Premios y Sorteos
