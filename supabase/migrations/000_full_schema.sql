...
CREATE TABLE IF NOT EXISTS agency_settings (
    ...
    phone TEXT DEFAULT '+54 11 4098-0758',
    whatsapp TEXT DEFAULT '5491140980758',
    email TEXT DEFAULT 'contacto@specialcars.com.ar',
    instagram TEXT DEFAULT 'https://instagram.com/specialcars',
    facebook TEXT DEFAULT 'https://facebook.com/specialcars',
    tiktok TEXT DEFAULT 'https://tiktok.com/@specialcars',
